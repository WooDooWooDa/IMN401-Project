...
public:
	/**
	 * @brief      Creates a new Framebuffer object with a color and depth attachment of given width and height. Takes care of initialization. Add new constructor for variations (i.e. without depth attachment, multiple attachments...)
	 */
